...
from info import DATABASE_NAME, OTHERDB_URI, IMDB, IMDB_TEMPLATE, MELCOW_NEW_USERS, P_TTI_SHOW_OFF, SINGLE_BUTTON, SPELL_CHECK_REPLY, PROTECT_CONTENT
...
db = Database(OTHERDB_URI, DATABASE_NAME)
